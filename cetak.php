...
<h2 align="center" >Laporan Hasil Perhitungan Pemilihan Mitra Jasa Pengiriman<br>PT. Sinergi Inti Plastindo Tbk<br>
Menggunakan Metode TOPSIS</h2>
...
<th width="12%" bgcolor="#CCCCCC">Hasil Akhir</th>
</tr>
</thead>
<tbody>
<?php
...
<table  border="0" width='80%' align="center">
    <tr>
        <td colspan="3" align="right">Surabaya, <?php echo date('d-M-Y'); ?></td>
    </tr><tr>
